...
// This needs to be a wrapper that reads the form data first
export const uploadLessonFile = async (req, res, next) => {
  // For multipart/form-data, we need to parse it first
  // We'll use a combined approach: try both, but check body first if available
